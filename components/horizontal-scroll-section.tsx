    ...
    <section className="relative py-16 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h2 className="text-3xl font-light text-masters-charcoal mb-2">
              {title}
            </h2>
            <div className="flex items-center gap-4">
              <div className="h-0.5 w-32 bg-masters-pine/20" />
              <span className="text-sm text-masters-slate">
                Scroll to explore
              </span>
            </div>
          </div>
        ...
        <div className="relative">
          ...
          >
            {formats.map((format, index) => (
              ...
              >
                <div className="group bg-white h-full p-8 cursor-pointer
                  transition-all duration-500 hover:shadow-2xl
                  border border-masters-stone/20 hover:border-masters-pine/30"
                  style={{
                ...
                >
                  ...
                  <div className="flex items-start justify-between mb-6">
                    <span className="text-5xl font-light text-masters-pine/20">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <h3 className="text-2xl font-light text-masters-charcoal mt-1 
          ...
          {/* Progress Bar */}
          <div className="mt-6 h-0.5 bg-masters-stone/20 rounded-full overflow-hidden">
            <div 
